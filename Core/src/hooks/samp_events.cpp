...
namespace Hooks {
    ...
    void InitializeChatCommands() {
        // Логика обработки команд /vlc и /menu, а также зависимости от imgui_menu удалены.
        // Функция оставлена пустой, чтобы не ломать вызовы из main.cpp.
        // В будущем сюда можно добавить обработку других команд.
    }
